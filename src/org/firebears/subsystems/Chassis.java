...
public class Chassis extends Subsystem {
	...
	/** 
	 * Our practice robot uses CAN Jaguars, while our competition robot uses
	 * CAN Talons.   For some reason, the Talons are reversed with respect to
	 * the values inputted.   This method can reverse the chassis, so the same
	 * code can run in both robots.
	 * 
