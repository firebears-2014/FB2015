...
public class  AutoTM extends CommandGroup {
    public AutoTM() {
    	...
    	addSequential(new SetHeightCommand(Robot.lift.HEIGHT_3));		//Lifts container up
		...
		addSequential(new SetHeightCommand(Robot.lift.HEIGHT_2));		//places container on tote
		...
		addSequential(new SetHeightCommand(Robot.lift.HEIGHT_0));		//sets arms to floor
    	...
    	addSequential(new SetHeightCommand(Robot.lift.HEIGHT_0));		//releases tote
    	addSequential(new WaitCommand(.4));
